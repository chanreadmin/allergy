<div class="card">
    <div class="card-header">
        ...
        <a href="allergic-rhinitis.php?pid=<?php $pid = intval($_GET['pid']);
        echo $pid; ?>" style="float:right" class="btn btn-primary btn-sm">Add
            Follow Up</a>
    </div>
    <div class="card-body">
            ...
            <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="view-allergic-followup.php?pid=<?php echo htmlentities($row['id']); ?>"
