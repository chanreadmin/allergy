                                        ...
                                        <table id="buttons-datatables" class="display table table-bordered"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="view-ar-followup.php?pid=<?php echo htmlentities($row['patient_id']) ?>"
                                                            class="btn btn-primary btn-sm">Allergic Rhinitis</a>
                                                        |
                                                        ...
                                                        <a class="btn btn-info btn-sm"
                                                            href="view-bronchitis.php?pid=<?php echo htmlentities($row['patient_id']) ?>">
                                                            Allergic Bronchitis</a>
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                        </table>
