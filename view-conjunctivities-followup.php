                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Allergic Conjuctivities</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Forms</a></li>
                                        <li class="breadcrumb-item active">Allergic Conjuctivities</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Allergic Conjuctivities</h4>
                                </div>
                                <div class="card-body">
                                    <div class="live-preview">

                                        <?php
                                            $queryId = mysqli_query($conn, "Select * from tbl_conjunctivities where id = '$sid' ");
                                            ...
                                            <div class="col-xxl-3 col-md-9">
                                                <div>
                                                    ...
                                                    <input type="radio" name="discomfort" id="discomfort"
                                                        <?= $row['discomfort'] ? "checked" : '' ?> value="Discomfort">
                                                    Discomfort &nbsp;
                                                    <input type="radio" name="discharge" id="discharge"
                                                        <?= $row['discharge'] ? "checked" : '' ?> value="Discharge">
                                                    Discharge &nbsp;
                                                    <input type="radio" name="photophobia" id="photophobia"
                                                        <?= $row['photophobia'] ? "checked" : '' ?> value="Photophobia">
                                                    Photophobia
