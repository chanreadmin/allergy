                                            ...
                                            <form action="components/atopic-follow.php?pid=<?php echo $sid; ?>"
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div>
                                                        ...
                                                        <input type="text" name="symptoms" id="symptoms"
                                                            placeholder="Enter Symptoms.." class="form-control">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-xxl-3 col-md-6">
                                                ...
                                                <div class="col-xxl-6 col-md-6">
                                                    <div>
                                                        ...
                                                        <textarea class="form-control" name="pmedications" id="pmedications"
                                                ...
                                                <div class="col-xxl-6 col-md-6">
                                                    <div>
                                                        ...
                                                        <textarea class="form-control" name="lapplication" id="lapplication"
                                                            cols="30" rows="5"></textarea>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                ...
                                                <div class="col-xxl-6 col-md-6">
                                                    <div>
                                                        ...
                                                        <textarea class="form-control" name="othermedications"
                                                            id="othermedications" cols="30" rows="5"></textarea>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <!-- ========================= Investigations ============================= -->
