                                ...
                                <div class="card-body">
                                    <div class="live-preview">
                                        <form method="post" enctype="multipart/form-data" class="row gy-4">
                                            <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    ...
                                                    <input type="text" name="drug_name" id="drug_name"
                                                        placeholder="Enter drug name.." class="form-control" required>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-xxl-3 col-md-6">
                                            ...
                                            <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    <label for="adverse" class="form-label">Instruction</label>
                                                    <input type="text" class="form-control" name="instruction"
                                                        id="instruction" placeholder="write here..(Optional)">
                                                </div>
                                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="buttons-datatables" class="display table table-bordered"
                                                ...
                                                <tbody>
                                                    <?php
                                                        $gid = intval($_GET['pid']);
                                                        $myquery = mysqli_query($conn, "Select * from tbl_prescription where patient_id = '$gid'");
