                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index.html" class="d-inline-block auth-logo">Allergy
                                    <!-- <img src="assets/images/logo-light.png" alt="" height="20"> -->
                                </a>
                            </div>
                            <p class="mt-3 fs-15 fw-medium">One stop solutions for Allergy</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form action="components/singup.php" class="needs-validation" novalidate
                                        method="POST">

                                        <div class="mb-3">
                                            <label for="username" class="form-label">Name <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="adminName" id="username"
                                        ...
                                        <div class="mb-3">
                                            <label for="username" class="form-label">Center Code <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="centerCode" id="centerCode"
                                                placeholder="Enter center code" required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="username"
                                                placeholder="Enter username" required name="adminUsername">
                                            <div class="invalid-feedback">
                                                Please enter username
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                <input type="password" class="form-control pe-5 password-input"
                                                    ...
                                                    pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" name="adminPassword"
                                                    required>
                                                <button
                                        ...
                                        <div class="mt-4">
                                            <button class="btn btn-success w-100" name="signup" type="submit">Sign
                                                Up</button>
                                        </div>
                                    </form>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">Copyright &copy;
                                ...
                                <!-- Developed with <i class="mdi mdi-heart text-danger"></i> by Shamim -->
                            </p>
                        </div>
                    </div>
                </div>
