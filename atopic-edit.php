                                            ...
                                            <div class="col-xxl-6 col-md-6">
                                                <div>
                                                    ...
                                                    <textarea class="form-control" name="pmedications" id="pmedications"
                                                        cols="30"
                                                        rows="5"> <?php echo htmlentities($row['pmedications']); ?></textarea>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            ...
                                            <div class="col-xxl-6 col-md-6">
                                                <div>
                                                    ...
                                                    <textarea class="form-control" name="lapplication" id="lapplication"
                                                        cols="30"
                                                        rows="5"><?php echo htmlentities($row['lapplication']); ?> </textarea>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <!--end col-->
                                            <div class="col-xxl-6 col-md-6">
                                                <div>
                                                    ...
                                                    <textarea class="form-control" name="othermedications"
                                                        id="othermedications" cols="30"
                                                        rows="5"><?php echo htmlentities($row['othermedications']); ?></textarea>
                                                </div>
                                            </div>
                                            <!--end col-->
