                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Add Users</h4>
                                                ...
                                                <form action="components/add-hospital.php" class="needs-validation"
                                                    ...
                                                    <div class="mb-3 col-xxl-4 col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="centerName"
                                                            ...
                                                            required value="<?php echo $_SESSION['centerName']; ?>"
                                                            readonly>
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <div class="mb-3 col-xxl-4 col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="centerCode"
                                                            ...
                                                            value="<?php echo $_SESSION['centerCode']; ?>" readonly>
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <div class="mb-3 col-xxl-4 col-md-6">
                                                        <label for="username" class="form-label"> User Type <span
                                                                class="text-danger">*</span></label>
