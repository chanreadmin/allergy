                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table id="buttons-datatables" class="display table table-bordered"
                                                ...
                                                <tbody>
                                                    <?php
                                                    $myquery = mysqli_query($conn, 'Select * from patients');
                                                    while ($row = mysqli_fetch_array($myquery)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                |
                                                                <a href="" class="btn btn-warning">Add Medication</a>
                                                                |
                                                                <a href="" class="btn btn-success">Add Test</a>
                                                                |
                                                                <a href="add-history.php?pid=<?php echo htmlentities($row['id']) ?>"
