                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="live-preview">
                                        <form action="components/bronchitis.php?pid=<?php echo $sid; ?>" method="post"
                                                ...
                                                <table id="myTable" class="table table-strip">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="radio" id="lf" name="lf" value="0"> Normal
                                                            </td>
                                            ...
                                            <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    <input type="radio" name="habits" id="habits" value="Smoker"> Smoker
                                                    &nbsp;
