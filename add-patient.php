                                            ...
                                            <form class="row gy-4">
                                                <div class="col-xxl-3 col-md-6">
                                                    <div>
                                                        ...
                                                        <input type="password" name="patient_name" id="patient_name"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="radio" id="eczema" class="btn btn-success"
                                                                        name="eczema" value="Yes">
                                                                </td>
                                                                <td><input type="radio" id="eczema" name="eczema"
                                                                        value="No">
                                                                </td>
                                                            </tr>
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div>
                                                        ...
                                                        <input type="text" class="form-control" id="exacerbations"
                                                            name="exacerbations">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div id="admhospital_yes" class="hidden">
                                                        <input type="text" class="form-control" id="admhospital_yes"
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div id="gp_yes" class="hidden">
                                                        <input type="text" class="form-control" name="gp_yes"
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div id='ae_yes' class="hidden">
                                                        <input type="text" class="form-control" name="ae_yes"
                                                            placeholder="Write here">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div id="itu_yes" class="hidden">
                                                        <input type="text" class="form-control" name="itu_yes"
                                                            placeholder="Write here">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div class="hidden" id="coughwhz_yes">
                                                        <input type="text" class="form-control" name="coughwhz_yes"
                                                            placeholder="Write here">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div>
                                                        <input type="radio" id="intervaly"
                                                            onclick="intervalsymptoms('show')" name="interval" value="Yes">
                                                        Yes &nbsp;
                                                        <input type="radio" id="intervaln"
                                                            onclick="intervalsymptoms('hide')" name="interval" value="No">
                                                        No
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-6">
                                                    <div id="interval_yes" class="hidden">
                                                        <input type="text" class="form-control" name="interval_yes"
                                                            placeholder="Write here">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-6">
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div id="cough_night_yes" class="hidden">
                                                        <input type="text" class="form-control" name="cough_night_yes"
                                                            placeholder="Write here">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-6">
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div id="exercise_yes" class="hidden">
                                                        <input type="text" class="form-control" name="exercise_yes"
                                                            placeholder="Write here">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-6">
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div id="smoke_yes" class="hidden">
                                                        <input type="text" class="form-control" name="smoke_yes"
                                                            placeholder="Write here">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-6">
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div id="pets_yes" class="hidden">
                                                        <input type="text" class="form-control" name="pets_yes"
                                                            placeholder="Write here">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-6">
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div>
                                                        ...
                                                        <select class="js-example-disabled-multi" name="screening[]"
                                                            multiple="multiple">
                                                ...
                                                <div class="col-xxl-3 col-md-6">
                                                    <div>
                                                        ...
                                                        <input type="file" name="hypertension" class="form-control">
                                                    </div>
                                                </div>
